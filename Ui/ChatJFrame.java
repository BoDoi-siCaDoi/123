...
public class ChatJFrame extends javax.swing.JFrame {
    ...
    if (!tinNhan.isEmpty()) {
        ...
        String tenNguoiDung = Utils.Auth.currentUserTenDangNhap;

        // Hiển thị tin nhắn của người dùng
        txtaTinNhan.append(tenNguoiDung + ": " + tinNhan + "\n");

        // (Tuỳ chọn) Giả lập phản hồi từ bot
        txtaTinNhan.append("DTLNT Bot: Cảm ơn bạn đã nhắn tin!\n");
