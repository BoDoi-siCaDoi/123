...
public class DonHangEntity {
    ...
    private boolean trang_thai; // Trạng thái đơn hàng (true = đã xử lý, false = chưa xử lý)

    // Constructor đầy đủ
    public DonHangEntity(int id_don_hang, int id_tk, int tong_tien, String thoi_gian, boolean trang_thai) {
    ...
    public DonHangEntity(int id_tk, int tong_tien, String thoi_gian, boolean trang_thai) {
        this.id_tk = id_tk;
        this.tong_tien = tong_tien;
        this.thoi_gian = thoi_gian;
        this.trang_thai = trang_thai;
